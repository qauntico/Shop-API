...
const {create,list, listBySearch,listSearch,listRelated,update,singleProduct,photo,remove,productId} = require('../controllers/product');
...
router.delete('/product/:productId/:userId',isRegistered,isAdmin, authentication, remove);
